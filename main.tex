...
$\cat{C}_T$, has as objects the objects of $\cat{C}$, and as morphisms
...
and $(T,\eta,\mu)$ is a monad on $\cat{C}$.  Objects are interpreted
...
interpretation brackets from types and objects.
...
\begin{definition}
  ...
  \begin{mathpar}
    ...
    \morphism(-400,500)|a|/->/<2000,0>[
      A \times TB`
      T(A \times B);
      \mathsf{st}_{A,B}]

    \Atriangle(-600,500)|mma|<1000,500>[
      A \times B`
      A \times TB`
      T(A \times B);
      \id_A \times \eta_B`
