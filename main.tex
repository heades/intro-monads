...
% subsection decomposing_monads_into_adjunctions (end)
...
%% \newcommand{\limit}[2]{\underleftarrow{\mathsf{lim}}_{#1}#2_{#1}}
%% %% Suppose we have a limit $p_i : \limit{j}{D} \to D_i$ in $\cat{C}$ and
%% %% a monad $(T, \eta, \mu)$ on $\cat{C}$.  Then we show that $p_i$ lifts
%% %% to a limit, $p'_i : \limit{j}{TD} \to TD_i$, on pure morphisms in the
%% %% Kleisli category $\cat{C}_T$ of $T$.
%% % subsection what_properties_lift_to_the_kleisli_and_eilenberg-moore_categories? (end)
