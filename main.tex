...
we can define the following distributive law\footnote{For the entire implementation please see \url{ (writing \verb!List a!
instead of \verb![a]! for readability):
\begin{center}
  \begin{verbatim}
